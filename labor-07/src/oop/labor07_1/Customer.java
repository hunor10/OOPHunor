...
public class Customer {
    ...
    {
        ArrayList<String> accountss=new ArrayList<>(accounts.size());
        for(BankAccount accountssss:accounts)
        {
            accountss.add(accountssss.getAccountNumber());
        }
        return accountss;
    }
    ...
    public String toString() {
        ...
        result.append("Customer ID:").append(id).append("\n").append(firstName).append(' ').append(lastName).append(" accounts:\n");
        for (BankAccount item : accounts) {
